<template>
	<div>
		...
		<div class="form">
			<form action="">
				<div class="one"><img src="../../../static/img/sign_icon_phone01.png" alt="" class="img"><input type="text" placeholder="用户名/手机号" v-model="user"></div>
				<div class="tow"><img src="../../../static/img/sign_icon_lock01.png" alt="" class="img"><input type="password" placeholder="请输入密码" v-model="pass">
