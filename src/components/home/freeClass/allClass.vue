<template>
  <div>
    <other-class v-for="(item,index) in shuju[0].list" :key = 'index' :people='item.people' :classprice="item.price"
    ...
    <other-class v-for="(item,index) in shuju[2].list" :key = 'index' :people='item.people' :classprice="item.price"
     :classSrc = 'item.img_src'  :className="item.class_title" :classlevel='item.class_level'>
    </other-class>
    <other-class v-for="(item,index) in shuju[3].list" :key = 'index' :people='item.people' :classprice="item.price"
     :classSrc = 'item.img_src'  :className="item.class_title" :classlevel='item.class_level'>
    </other-class>
