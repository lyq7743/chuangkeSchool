  ...
  <div>
    <header class="classes-header">
      ...
      <div class="top">
        <div class="main">
          <p>我的班级</p>
          <div v-show="this.$store.state.user !=0?false:true">
      ...
      <div class="main">
        <div class="banner">
          <img src="../../static/img/un_buy_class.jpg" />
        </div>
        <!--购买课程-->
        <div class="course">
          <div class="left">
          ...
          <div class="right">
            <div class="icon">
              <img src="../../static/img/ic_class_people_w.png" />
            </div>
            <div class="button">
              <span>购课咨询</span>
              <img src="../../static/img/a7.png" />
      ...
      <div class="main">
        ...
        <div class="title title3">
          <div>
            <!-- 背景图片（小圆） -->
            <div class="back2">
              <img src="../../static/img/a6.png" />
            </div>
          </div>
        </div>
        <!-- 学前测试 -->
        <div class="test" v-for="(item,index) in arr">
          <div>
            <div class="icon">
              <img :src="item.imgsrc" />
            </div>
